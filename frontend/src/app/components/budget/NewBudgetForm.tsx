...
type BudgetFormInput = Omit<BudgetInputType, "budgetAmount"> & {
  budgetAmount: string;
};
        ...
        <DialogTrigger asChild>
          <Button
            className={`w-full h-14 text-lg font-semibold rounded-lg shadow-lg transition-all duration-300 ${
              isHovered
                ? "bg-gradient-to-r from-blue-600 to-blue-500 scale-[1.02] shadow-xl"
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`w-full h-11 ${
                  errors.budgetName ? "border-red-500" : "border-gray-200"
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={`w-full h-11 pl-10 ${
                    errors.budgetAmount ? "border-red-500" : "border-gray-200"
                  } focus:ring-2 focus:ring-blue-200`}
                />
              </div>
              {errors.budgetAmount && (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleSelectChange("budgetPeriod", value)
                  }
                >
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleSelectChange("budgetCategory", value)
                  }
                >
